...
CREATE TABLE IF NOT EXISTS `mydb`.`Tab_city` (
  ...
  UNIQUE INDEX `z_UNIQUE` (`z` ASC)  COMMENT '',
  UNIQUE INDEX `y_UNIQUE` (`y` ASC)  COMMENT '',
  UNIQUE INDEX `x_UNIQUE` (`x` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Tab_city_Tab_building` (
  ...
  `y` INT NOT NULL COMMENT '',
  `z` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id_city`, `id_building`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Tab_city_has_resources` (
  ...
  `y` INT NOT NULL COMMENT '',
  `z` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id_city`, `id_resources`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Tab_player_has_world` (
  `id_player` INT NOT NULL COMMENT '',
  `id_world` INT NOT NULL COMMENT '',
  PRIMARY KEY (`id_player`, `id_world`)  COMMENT '',
  INDEX `fk_Tab_player_has_Tab_world_Tab_world1_idx` (`id_world` ASC)  COMMENT '',
  INDEX `fk_Tab_player_has_Tab_world_Tab_player1_idx` (`id_player` ASC)  COMMENT '',
